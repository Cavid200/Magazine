    ...
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                ...
                <div class="col-6">
                    <a style="float: right" href="{{ route('admin.setting.create') }}" class="btn btn-success">{{ __('create') }}</a>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <tbody>
                                    @foreach ($settings as $setting)
                                        <tr>
                                            ...
                                            <td><img src="{{ asset($setting->logo) }}" alt="" style="width: 100px"></td>
                                            <td>
                                                <a href="{{ route('admin.setting.edit', $setting) }}"
                                                    class="btn btn-success">{{ __('edit') }}</a>
                                                    <a href="{{ route('admin.setting.destroy', $setting) }}"
