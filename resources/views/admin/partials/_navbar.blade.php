    ...
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid"
                        src="{{ asset('backend') }}/assets/images/logo/logo.png" alt=""></a></div>
            ...
            <ul class="nav-menus">
                <li class="language-nav">
                    <div class="translate_wrapper">
                        <div class="current_lang">
                            <div class="lang"><i class="flag-icon flag-icon-{{app()->getLocale()=='en' ? 'us': app()->getLocale()  }}"></i><span
                ...
                <li class="profile-nav onhover-dropdown p-0 me-0">
                    <div class="media profile-media"><img class="b-r-10"
                            src="{{ asset(auth()->user()->image)}}" style="width: 50px" alt="">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        ...
                        <li><a href="{{ route('admin.logout') }}"><i data-feather="log-in"> </i><span>Log in</span></a></li>
                    </ul>
                </li>
            </ul>
        </div>
